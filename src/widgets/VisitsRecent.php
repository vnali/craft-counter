...
class VisitsRecent extends Widget
{
    ...
    private ?VisitsRecentStats $_stat = null;
    ...
    public function init(): void
    {
        ...
        $this->_stat = new VisitsRecentStats(
            $this->dateRange,
    ...
    {
        return Craft::t('counter', 'Visits (Recent)');
    }
    ...
    public function getSettingsHtml(): ?string
    {
        ...
        return Craft::$app->getView()->renderTemplate('counter/_components/widgets/visitsRecent/settings', [
            'id' => $id,
